namespace ConstantsGenerator {
    ...
    public static class SublimeProjectsGenerator {
        static void SyncMonoDevelop () {
            Assembly unityEditor = Assembly.Load("UnityEditor");
            var syncVS = unityEditor.GetType("UnityEditor.SyncVS");
            MethodInfo syncSolution = syncVS.GetMethod("SyncSolution", BindingFlags.Public | BindingFlags.Static);
